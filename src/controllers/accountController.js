...
const handleRegister = async (req, res) => {
    ...
    try{
        ...
        res.cookie('jwt', refreshToken, {httpOnly: true,  sameSite: 'strict', secure: true, maxAge: refreshDay * 24 * 60 * 60 * 1000});
...
const handleSignOut = async (req, res) => {
    ...
    jwt.verify(
        ...
        (err, decode) => {
            ...
            res.cookie('jwt', '', {httpOnly: true,  sameSite: 'strict', secure: true, maxAge: 1});
            res.sendStatus(200);
        }
    );
